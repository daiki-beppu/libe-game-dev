...
const JOBS = [
  ...
  },
  {
    ...
    speed: 2.7, weight: 0.8, aiRange: 200,
    desc: '遠くから削る。ファイアボールは爆発で吹き飛ばす',
    attack:  { label: '魔法弾',         kind: 'projectile', startup: 6,  recovery: 15, speed: 7,   radius: 7,  life: 42, dmg: 3,  base: 2,   growth: 0.05, shape: 'orb' },
    special: { label: 'ファイアボール', kind: 'projectile', startup: 22, recovery: 20, speed: 4.2, radius: 14, life: 90, dmg: 12, base: 5.5, growth: 0.16, shape: 'fire', explode: 70, cooldown: 140 },
  },
  {
    id: 'archer', name: '弓使い', icon: '🏹', color: '#4caf50',
    speed: 3.0, weight: 0.9, aiRange: 220,
    desc: '速い矢で牽制。三連矢で逃げ道をふさぐ',
    attack:  { label: '矢',     kind: 'projectile', startup: 10, recovery: 18, speed: 9,  radius: 5, life: 32, dmg: 4, base: 2.5, growth: 0.06, shape: 'arrow' },
    special: { label: '三連矢', kind: 'projectile', startup: 14, recovery: 18, speed: 9,  radius: 5, life: 30, dmg: 5, base: 3.5, growth: 0.10, shape: 'arrow', count: 3, spread: 18, cooldown: 110 },
  },
  {
  ...
  },
  {
    ...
    attack:  { label: '杖打ち',     kind: 'melee', startup: 6,  active: 4, recovery: 12, range: 56, arc: 60, dmg: 6, base: 3, growth: 0.10 },
    special: { label: '聖なる波動', kind: 'nova',  startup: 15, active: 4, recovery: 20, radius: 120, dmg: 8, base: 6.5, growth: 0.12, heal: 12, cooldown: 140 },
  },
  {
    id: 'knight', name: '騎士', icon: '🛡️', color: '#4f8fe6',
    speed: 2.4, weight: 1.3, aiRange: 80,
    desc: '最重量。長いが隙の大きい槍と、読み勝てば強烈なカウンター',
    attack:  { label: '槍突き',     kind: 'melee', startup: 12, active: 4, recovery: 20, range: 90, arc: 18, dmg: 7,  base: 3.5, growth: 0.09 },
    special: { label: 'カウンター', kind: 'guard', startup: 2, active: 24, recovery: 18, dmg: 10, base: 5.5, growth: 0.12, cooldown: 130 },
  },
];
